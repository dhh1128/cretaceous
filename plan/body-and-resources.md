...
What they carry out of the border-tangle, per the decision log:

- **Keo** — three strips of journey-pan, two handfuls of roasted crawlers
- **Teva** — journey-pan and crawlers
- **Benal** — journey-pan only. **He forgot the protein, and said so.**

That is roughly **two days of food for three people, for an eleven-day <!-- @WF-mudwalk.days: 11 --> walk.** Which is correct — they left at night, in a hurry, stealing — but it means **foraging is not texture, it is the spine of the act.** Every day has a food problem, starting on Day 4.

**They cannot forage enough, and this is worth being honest about.** Three teenagers walking 8–12 km a day over broken ground, carrying packs, in heat, need something on the order of 3,500–5,000 kcal each. Opportunistic foraging in woodland — fruit, snails, pinyons, the occasional grounder — returns a few hundred to perhaps 1,500 kcal a day per person, and that is on good days with time to spend. **They run a deficit the entire journey.** Over eleven days <!-- @WF-mudwalk.days: 11 --> that is several kilos each, and by the coast they are visibly diminished: loose belts, sharp faces, cold at night, slow to stand.

**And the consequence nobody has planned: the journey out is only survivable one way.** They arrive at the coast without the reserves to walk back. Somebody should work this out around Day 10 or 11 and not say it, and somebody else should say it on Day 14. It is a stakes escalation that costs nothing to add and it makes the wig a rescue rather than a convenience.
...
### The healing upgrade is a liability, not a cheat

Keo and Teva both have profound accelerated healing, which would defuse every injury in the book if it were free. **It is not free: it is metabolically expensive.** Healing fast in a caloric deficit means healing at the expense of everything else — Keo closes a wound and pays for it in strength, warmth and clarity. <!-- @WF-healing.cost: strength-warmth-clarity --> Benal's healing is moderate, so his injuries persist longer and cost him less, and by the end of Act 2 that difference has inverted who is coping.

## 2. Water

More urgent than food, and it inverts across the journey.

**Days 3 and 10** are dry and hot, and water is the problem — Day 10 in particular, where the scene list already has them down to a half canteen on the savanna, with heat killing Teva and no shade.

**Days 4–6 and 11–13** are wet, and water is everywhere, which solves drinking and creates every other problem: soaked constantly, nothing dries, foot rot, gear degrading.

**The obvious way to get water is where the crocs are**, always. The buddy rule is not a tradition out here, it is the only reason they are alive, and the first time one of them breaks it should be a scene. Possibly they can collect water in a large leaf once or twice.

## 2b. The marching day — they do not walk at noon

Explorers with two centuries of accumulated field knowledge have a doctrine, and it is not "walk until dark."

| block | what happens | why |
|---|---|---|
| **pre-dawn to ~1000** | **the main march.** Out in the last of the fog, moving as it lifts | Cool. Fog conceals them. By the time footing matters they can see the ground. Their best hours, every day. |
...
### Fill it with hands, not with talk
...
Distances are in `journey-calendar.md` §1 and are not repeated here. **Nothing resets between days.**

**And *carried* is two words in this chain, so the physical one is the only one this table means.** **Keo is never physically carried** <!-- @WF-keo.carried: false --> — no litter, no shoulder, no frame, on any day. What Days 11 and 12 cost the party is his pace, his pack on Teva's back on top of her own, and the healing upgrade burning reserves he has not got; that is the whole of what the arcs mean when they call him the burden. **Teva is carried, and from Day 13** <!-- @WF-teva.carried.from: D13 -->: her hand, then her arm over his shoulder, then on his back, then the drag-frame at D13.2. Keo is the one doing it. A litter for him at any point spends that escalation early and there is only one of it. @D13.2
...
| **8** | they eat before, because nobody knows about after | the crossing is not a drink | everyone soaked; **the last of the septic gel goes on before they enter the water, because entering that water without it is unthinkable — and the water takes it off them inside the hour.** <!-- @WF-barrier.lost: D8 --> Nobody notices, and the pot is empty in the pack for four days before anyone reaches for it. Keo's projection headache at its worst — he holds two tonnes <!-- @WF-decoy.mass: 2t --> of panicking animal through the whole of it | **the highest they ever get.** They did the thing they could not do | nothing all morning, then the crossing, then an hour of nobody able to stand up. A short shift before dark and two kilometers on the map |
| **9** | forage thinning; the last of what Day 6 gave them | showers; plentiful | Benal's chest still sore from Day 5; first hot spot on Keo's foot | quiet and enormously pleased with themselves. This is the last of that | steady, and long. The ground rising toward the savanna |
| **10** | full from the good day, which is why they push | **half a canteen by afternoon.** This is the crisis | **Teva: sunfever.** Dizzy, dry, hiding it. Suit thermal system saturating. **Keo: burned** — unsuited, no shade, UV all day. He does not notice until night | Keo at hubris peak, flying. Teva concealing collapse. Benal enduring and watching them both | no lay-up, and that is the mistake |
| **11** | nobody eats | rain solves water and solves nothing else | **Noli. Then Keo's fall** <!-- @WF-noli.death.day: 11 --> — limestone scree, deep laceration to the outer thigh above the knee, cracked rib, the ankle wrenched. Bleeding into a wet dressing. Teva unshelled since yesterday's saturation, and the rain is the first mercy she has had | **the floor.** Nobody wants to move and they move four kilometers | barely moving. They stop before dark because Keo cannot go on |
| **12** | **and this is the day somebody reaches for the gel and finds the pot empty.** Almost nothing. **The grounders stop, because Noli caught them** — and this is the day Teva short-leaches the mash. Keo cuts wild cycad on the morning march with the tooth-knife; they cut all morning meaning to reach the coast on it and **the wild plant pays about half what they went at it for** — barely two days of thin food for three — and that labor is why they make four kilometers and not six. It is pounded between a loose stone and the rock, and leached in **the spare water skin, cut open and perforated** — spent, and they are four days from a coast. **Teva eats a full portion of the four-hour batch and nobody else eats at all.** Then the remainder goes into the runoff overnight, which is Keo's method adopted after he was overruled, and nobody says so. **In the night an animal takes about a third of it**, which leaves one meal | plentiful — rain. **They do not drink the sulfur spring** and nobody explains why | Keo febrile — infection, and the healing upgrade burning through reserves he does not have. **Nobody carries him, today or ever: he walks, slowly, with nothing on him, and Teva has his load as well as her own** <!-- @WF-keo.carried: false --> — the literal carry that starts on Day 13 is hers and he is the one doing it. Benal takes watches he cannot afford | grinding. This is the day the reader should feel the walk | slow, and every kilometer is negotiated |
| **13** | **the mash is breakfast and then it is gone** — one meal each at dawn from the overnight batch, and nothing after it. Then forage returns — carcass beetles, fruit, fish, and none of it stays down for Teva | clearing | **the mash comes due, and only for her.** She ate the four-hour batch; Keo and Benal eat at dawn from the same mash after a night in the runoff, which is roughly three times the leaching, so **they are queasy all day and never down and she is the one who goes.** Vomiting, cramping, and losing water she cannot spare, about eighteen hours <!-- @WF-mash.onset: 18h --> after her portion. **Her caution is the dose: she went first so that nobody else would have to.** Keo's wound closing fast and costing him everything; he is thin, cold, quiet — starvation cold, not weather. **Keo carries her** <!-- @WF-teva.carried.from: D13 --> | hollow. Moving well, nobody talking. The bond is real and nobody has energy for it | steady, silent, efficient |
| **14** | ovos at the turtle beach — the last real meal | brackish, then salt | cuts from rudist shell; salt in everything open | **dread.** The sea, then the wall of black | **their longest day, and it is fear that does it.** Their fastest day and their two slowest are 6, and 7 and 8 — one from joy, two from terror, and that pairing is worth the reader noticing |
...
- **Biofilm dies in patches** where cut, abraded, starved or outcompeted by local microbes. A dead patch is a hole in the camouflage until it regrows, and **regrowth costs sugar** — so the suit heals at the same table as the people.
- **Thermal saturation.** The phase-change reservoirs fill and cannot dump heat faster than it arrives. Discharge needs cool conditions, so **a hot night does not reset it** and the deficit carries into the next day.
- **Power starvation.** Photovoltaic needs light and is blocked by canopy and by mud; thermoelectric needs a gradient and this climate barely offers one; piezoelectric needs movement. **So generation is near zero exactly when they are lying up in shade** — the suits work worst when the wearers are sheltering.
- **Seal breaches** at the joints, which is where the constrictor gets Benal.
- **Sensors fouled** by mud, salt and gel — and the chemical sensors are blinded by **the pheromone barrier they are wearing.** The thing that hides them from predators hides the predators from their suits.
- **Salt**, which is catastrophic. A living biofilm in seawater is an osmotic disaster.
...
The weather turns after Day 3, so **they walk out with good gear and the rains start eating it.** Days 4–5 and 11–13 are wet and nothing dries.
...
| 8 | the crossing soaks everything |
...
A suit reads its wearer's vitals and wakes its archaea on confirmed death — see `kb/worldbuilding/safety-suits.md`. The margin is short, because it has to be, and **there is an override that Keo knows and the other two do not.**

So: a suited character knocked unconscious, and a suit beginning to decide. **Day 5, Benal under the constrictor** is where it sits most naturally — he is crushed, not breathing properly, and pinned, and the thing that was protecting him starts working out whether he is dead. Keo has to reach him and know what to do, which is the one moment in Act 2 where his parents' training is worth more than his strength.

It is also the first time the reader understands, viscerally, what the suits are actually for. **Unspent. Take it or leave it, but do not let it go unnoticed.**

### Sleep

Three of them, so watches are three hours each and nobody gets an unbroken night after Day 3. **Cumulative sleep debt is the quiet driver of everything on Days 11–13** — the bad decisions, the short tempers, the missed sightlines. It should never be named as a cause and should be visible in every symptom.
