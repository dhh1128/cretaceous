...
| **2.3** Keo with his parents | **this family has jokes that predate the novel, and that is the whole assignment.** Riel's precision is the delivery mechanism: an exact number where anyone else would give an impression, and the exactness is the joke. An old running bit about Joram's silence that all three can run without explaining. **The register dies the instant Alira's name is said** and does not return in the scene — which is how the reader learns what the morning cost |
