...
# The second jump — the deep backstory

**This file exists because the novel shows the tip of it and the sequels show the rest, and every hint dropped in book 1 has to be consistent with material no reader will meet for two more books.** Nothing here is a scene. It is what is true, in order, so that a drafter never invents a detail that a later book has to work around.

**Read the boundary section last and treat it as binding.** Most of what follows is *not* revealed in book 1.

Marked `[?]` items are proposals from a session, not rulings. Everything unmarked came from Daniel directly and is his.
...
**Note what has just happened, because it inverts across two centuries.** Cecilia is the one arguing to act and accept the risk. The leadership is the party of caution. Their descendants swap: Cecilia's line becomes the purest Traditionalist voice in the colony, and the heirs of the men who would not gamble become the Branchers.
...
**Those who stay see the others off and vow to continue the work.** The Enclave never hears from them again and has assumed for two hundred years that they died. Two hundred left, suited; ninety-four arrived.

**All of that happens inside the third year.** The failure, the argument, the preparation, and then a walk of a week to a month — `plan/milieu-brief.md` §3 owns the timing and it is not three years of marching. The three years are the occupancy at Genesis, and the party is at the Enclave by the end of them.
...
The protocol is hers alone and it is not reckless. A blood test detects progression well before she becomes contagious, and the disease spreads by fluids and droplets, so the failure mode has an answer: **if it takes, she walks out and lets something eat her before she can pass it to anyone.** In a world of crocs and tyrannosaurs, disappearing completely is the one thing that is easy.
...
Every day at Genesis is now a day that might be the last one. They are no closer to testing the cure, no closer to building the equipment, and they have just learned that the deadline may be inside their own lifetimes.

**So they jump again.** They still have the apparatus that was to carry them home. They reorient it to go further back instead of forward, and they go **one thousand years**, to the same spot.

They go **before Cecilia can reach them with what she has proved.**
...
## 9. What the colony knows, and how the numbers close
...
## 10. The boundary — what book 1 shows

**Book 1 reveals exactly three things from this file:**

1. **Another group jumped backward.** The distance is not stated and does not need to be.
2. **That jump is what causes the temporal flashes.**
3. **The upgrades are the cure.**
